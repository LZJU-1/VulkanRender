...
- v4 GPU deferred/SSAO path: offscreen G-buffer attachments, independent SSAO and blur targets, fullscreen deferred composition, SSAO contact occlusion, debug views, and a Renderer72-scale many-light demo with 1024 storage-buffer lights and 10000 instanced PBR spheres.

## Next Engineering Steps

1. Add indirect draw and GPU culling for the v4 benchmark path.
