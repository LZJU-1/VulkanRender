...
- v4 GPU deferred/SSAO path: offscreen G-buffer attachments, independent SSAO and blur targets, fullscreen deferred composition, and SSAO contact occlusion.

## Next Engineering Steps

1. Add v4 deferred debug views and the Renderer72-style many-light benchmark scene.
